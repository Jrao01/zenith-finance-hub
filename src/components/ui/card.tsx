...
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    ...
    glass:
      "rounded-xl border border-border/50 bg-card/80 backdrop-blur-sm text-card-foreground shadow-md",
    stat: "rounded-xl border-0 gradient-card text-card-foreground shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-0.5",
  };
